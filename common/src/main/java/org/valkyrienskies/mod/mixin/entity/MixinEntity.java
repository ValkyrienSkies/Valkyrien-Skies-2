...
public abstract class MixinEntity {
    ...
    /**
     * This mixin disables the following code in Entity.move().
     *
     ...
     *
     * <p>This code makes accurate collision with non axis-aligned surfaces impossible, so this mixin disables it. </p>
     */
    @Redirect(method = "move", at = @At(value = "INVOKE", target = "Lnet/minecraft/entity/Entity;setVelocity(DDD)V"))
    private void redirectSetVelocity(final Entity entity, final double x, final double y, final double z) {
        // do nothing
    }
