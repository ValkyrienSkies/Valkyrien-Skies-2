...
class ValkyrienSkiesModQuilt : ModInitializer {

    companion object {
        init {
            CoreHooks = QuiltHooksImpl
        }
    }
    ...
    override fun onInitialize(mod: ModContainer) {
        ...
        val isClient = MinecraftQuiltLoader.getEnvironmentType() == EnvType.CLIENT

        val module = VSCoreModule(QuiltHooksImpl, VSQuiltNetworking(isClient))
        ...
        ResourceLoader.get(SERVER_DATA)
            .registerReloader(object : IdentifiableResourceReloader {
