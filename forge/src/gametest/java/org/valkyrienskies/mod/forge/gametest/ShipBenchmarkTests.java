...
public class ShipBenchmarkTests {
    ...
    /**
     * Benchmark: Spawns 100 ships by repeatedly placing and assembling a block,
     * then measures the time for 100 subsequent server ticks with all ships loaded.
     */
    @GameTest(template = "empty_platform", timeoutTicks = 6000)
    public void benchmarkSpawn100ShipsAnd100Ticks(GameTestHelper helper) {
